                ...
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    handle: "/in/karim-boudabous-a389902b3/",
                  ...
                  },
                  {
                    icon: Mail,
                    label: "Email",
                    handle: "karimboudabous04@gmail.com",
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-white/30 truncate group-hover:text-current/50">
                        {handle}
                      </p>
                    </div>
                  </motion.a>
